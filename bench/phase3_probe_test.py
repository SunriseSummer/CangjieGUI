#!/usr/bin/env python3
"""Self-tests for phase3_probe.py's strict record aggregation and evidence logic."""

import importlib.util
import unittest
from pathlib import Path

spec = importlib.util.spec_from_file_location("phase3_probe", Path(__file__).with_name("phase3_probe.py"))
